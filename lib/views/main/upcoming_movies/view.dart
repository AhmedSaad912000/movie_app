...
import 'package:movie_app/bloc/main/upcoming_movies/upcoming_movies_bloc.dart';
...
import '../../sheets/show_movie_sheet.dart';
                            ...
                            showDialog(
                              ...
                              builder: (context) => ShowMovieSheet(
                                ...
                                onSelected: (type) {
                                  ...
                                  bloc.add(FilterUpcomingMoviesByGenreEvent(genreId:type.id));
                                },
                              ),
                            );
                          },
